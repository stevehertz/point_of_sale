                        ...
                        <form id="newProductForm" role="form">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="hidden" name="organization_id" class="form-control"
                                                id="newProductOrganizationId" placeholder="Enter product code"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="newProductType" name="product_type" class="form-control select2"
                                                style="width: 100%;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="newProductCategory" name="category_id" class="form-control select2"
                                                style="width: 100%;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="newProductCode">Bar/ Qr Code</label>
                                            <input type="text" name="product_code" class="form-control"
                                                id="newProductCode" placeholder="Enter product code">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="product_name" class="form-control"
                                                id="newProductName" placeholder="Enter product name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="newProductBrand">Brand</label>
                                            <select id="newProductBrand" name="brand_id" class="form-control select2"
                                                style="width: 100%;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="purchase_price" class="form-control"
                                                id="newPurchasePrice" placeholder="Enter purchase price">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="newSalePrice">Sale Price</label>
                                            <input type="text" name="selling_price" class="form-control" id="newSalePrice"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="newProductUnit" name="unit_id" class="form-control select2"
                                                style="width: 100%;">
                                ...
                                <div id="salePurchaseUnitRow">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="newProductSaleUnit">Sale Unit</label>
                                                <select id="newProductSaleUnit" name="sale_unit"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="newProductPurchaseUnit">Purchase Unit</label>
                                                <select id="newProductPurchaseUnit" name="purchase_unit"
                                                    class="form-control select2" style="width: 100%;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="newProductStocks" name="stocks" class="form-control" placeholder="Enter Number of Available stocks"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-9">
                                        <button type="submit" id="newProductSubmitBtn"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#newProductForm').submit(function(e) {
                ...
                var path = '{{ route('back.products.store') }}';
                $.ajax({
                    url: path,
                    type: "POST",
                    data: formData,
                    ...
                    complete: function() {
                        $('#newProductSubmitBtn').html('CREATE');
                    },
            ...
            $('#newProductUnit').change(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data['status']) {
                            ...
                            $('#newProductSaleUnit').append($('<option>', {
                                value: data['unit']['name'],
                                text: data['unit']['name']
                            }));
                            $('#newProductPurchaseUnit').append($('<option>', {
                                value: data['unit']['name'],
                                text: data['unit']['name']
                            }));
