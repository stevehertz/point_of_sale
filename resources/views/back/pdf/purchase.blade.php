...
<body>
    ...
    <div class="add-detail mt-10">
        <div class="w-50 float-left mt-10">
            <p class="m-0 pt-5 text-bold w-100">Purchase Id - <span class="gray-color">#6</span></p>
            <p class="m-0 pt-5 text-bold w-100">Purchase Date - <span class="gray-color">03-06-2022</span></p>
        </div>
